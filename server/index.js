...
const courses = [
	...
	{ id: "c3", code: "ALG101", name: "Algorithm Design" }
];
...
// COURSES
// =====================
app.get("/api/courses", authRequired, (_req, res) => {
	res.json(courses);
});
...
// ✅ NEW (for dashboard)
app.get("/api/enrollments", authRequired, (_req, res) => {
...
app.delete(
	"/api/students/:id/enrollments/:enrollmentId",
	authRequired,
	(req, res) => {
		const index = enrollments.findIndex(
			(e) =>
				e.id === req.params.enrollmentId &&
				e.studentId === req.params.id
		);
...
app.put("/api/enrollments/:enrollmentId/grade", authRequired, (req, res) => {
	...
	const enrollment = enrollments.find(
		(e) => e.id === req.params.enrollmentId
	);
